...
<nav class="navbar navbar-expand-lg bg-body-tertiary">
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      ...
      <!-- <a type="button" class="btn btn-primary" href="index.view.php">  index.view.php</a> -->
      <a type="button" class="btn btn-primary" href="addBooks.php">Add a book</a>
      <!-- <button  type="button" class="btn btn-primary"><a class="btn btn-primary" href="addBooks.php">Add a book</a></button> -->
